...
titulo = Label(frame_entrada, text= "NUMERO DE ENTEROS")
...
subtitulo2.config(bg="lightblue1", fg="black" , font=("Arial", 15))
subtitulo2.place(x=290, y=80)

logo= PhotoImage(file="entero.png")
etiq_logo=Label(frame_entrada, image=logo)
etiq_logo.config(bg="lightblue1")
etiq_logo.place(x=10,y=10)

etiq_a=Label(frame_entrada, text="Número N = ")
etiq_a.config(bg="lightblue1", fg="blue", font=("Arial", 15), anchor=CENTER)
